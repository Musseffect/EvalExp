 ...
 * can be found in the LICENSE.txt file in the project root.
 */
exports.atn = __webpack_require__(40);
...
exports.error = __webpack_require__(33);
...
var CommonTokenFactory = __webpack_require__(44).CommonTokenFactory;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.NegationNode = exports.TernaryOperatorNode = exports.DivisionNode = exports.SubtractionNode = exports.MultiplicationNode = exports.AdditionNode = exports.FunctionNode = exports.ConstantNode = exports.IdentifierNode = exports.ExpressionNode = exports.BoolConstantNode = exports.BoolOrNode = exports.BoolAndNode = exports.BoolNENode = exports.BoolENode = exports.BoolGENode = exports.BoolGNode = exports.BoolLENode = exports.BoolLNode = exports.BoolNegationNode = exports.BoolExpressionNode = exports.ASTNode = exports.TextPosition = exports.NodeType = void 0;
var NodeType;
(function (NodeType) {
    NodeType[NodeType["_Constant"] = 0] = "_Constant";
    NodeType[NodeType["_Identifier"] = 1] = "_Identifier";
    NodeType[NodeType["_Function"] = 2] = "_Function";
    NodeType[NodeType["_Addition"] = 3] = "_Addition";
    NodeType[NodeType["_Subtraction"] = 4] = "_Subtraction";
    NodeType[NodeType["_Multiplication"] = 5] = "_Multiplication";
    NodeType[NodeType["_Division"] = 6] = "_Division";
    NodeType[NodeType["_Negation"] = 7] = "_Negation";
    NodeType[NodeType["_Less"] = 8] = "_Less";
    NodeType[NodeType["_LessEqual"] = 9] = "_LessEqual";
    NodeType[NodeType["_Greater"] = 10] = "_Greater";
    NodeType[NodeType["_GreaterEqual"] = 11] = "_GreaterEqual";
    NodeType[NodeType["_Equal"] = 12] = "_Equal";
    NodeType[NodeType["_NotEqual"] = 13] = "_NotEqual";
    NodeType[NodeType["_And"] = 14] = "_And";
    NodeType[NodeType["_Or"] = 15] = "_Or";
    NodeType[NodeType["_Not"] = 16] = "_Not";
    NodeType[NodeType["_BoolConstant"] = 17] = "_BoolConstant";
    NodeType[NodeType["_Ternary"] = 18] = "_Ternary";
...
const expression_1 = __webpack_require__(22);
class FunctionDef {
...
class lerp extends FunctionDef {
    ...
    static derX(args) {
        return new expression_1.Subtraction(new expression_1.Constant(1), args[2]);
    }
    static derY(args) {
        return args[2];
    }
    static derT(args) {
        return new expression_1.Subtraction(args[1], args[0]);
    }
}
...
class Function extends Expression {
    ...
    differentiate(variable, epsilon = 0.001) {
    ...
    getDerivative(index, epsilon) {
        if (this.function.derivatives === null) { //use backward difference{
            ...
            return new Division(new Subtraction(new Function(this.functionName, this.args).clone(), new Function(this.functionName, argumentsBackward).clone()), new Constant(epsilon));
        }
...
exports.BailErrorStrategy = __webpack_require__(34).BailErrorStrategy;
...
// jshint ignore: start
var antlr4 = __webpack_require__(12);
var expGrammarVisitor = __webpack_require__(23).expGrammarVisitor;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.defineFunction = exports.$eval = exports.compileBool = exports.compile = void 0;
const functions_1 = __webpack_require__(21);
const visitor_1 = __importDefault(__webpack_require__(39));
const expressionCompiler_1 = __webpack_require__(56);
const errorListener_1 = __importDefault(__webpack_require__(57));
const compilerError_1 = __webpack_require__(58);
const expGrammarLexer_js_1 = __importDefault(__webpack_require__(59));
const expGrammarParser_js_1 = __importDefault(__webpack_require__(36));
const antlr4_1 = __importDefault(__webpack_require__(12));
function compile(expressionString, requiredVariables) {
    let errors = [];
    var chars = new antlr4_1.default.InputStream(expressionString);
    var lexer = new expGrammarLexer_js_1.default.expGrammarLexer(chars);
    ...
    var parser = new expGrammarParser_js_1.default.expGrammarParser(tokens);
    ...
    if (requiredVariables) {
        context.indicies = {};
        requiredVariables.forEach((val, id) => context.indicies[val] = id);
    }
    else
...
function compileBool(expressionString, requiredVariables) {
    let errors = [];
    var chars = new antlr4_1.default.InputStream(expressionString);
    var lexer = new expGrammarLexer_js_1.default.expGrammarLexer(chars);
    lexer.removeErrorListeners();
    ...
    if (requiredVariables) {
        ...
        context.indicies = varIndicies;
    context.errors = errors;
    let expression = expressionCompiler_1.compileBoolExpression(expDef, context).simplify();
    if (errors.length > 0) {
        throw new compilerError_1.CompilerError(errors);
    }
    return expression;
}
exports.compileBool = compileBool;
...
function defineFunction(name, func) {
    functions_1.functionDictionary[name] = {
        name,
        argCount: func.length,
        derivatives: null,
        exec: (args) => { return func(...args); },
        getDerivative: null
    };
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const expGrammarVisitor_js_1 = __importDefault(__webpack_require__(23));
const expGrammarParser_js_1 = __importDefault(__webpack_require__(36));
const astNode_1 = __webpack_require__(20);
class Visitor extends expGrammarVisitor_js_1.default.expGrammarVisitor {
    constructor() {
        super();
        this.idCount = 0;
        this.indicies = {};
    ...
    startBoolExpression(ctx, errorListener) {
        this.errorListener = errorListener;
    ...
    visitBBoolBinaryOperator(ctx) {
        let op = null;
        switch (ctx.op.type) {
            case expGrammarParser_js_1.default.expGrammarParser.AND:
                op = new astNode_1.BoolAndNode(this.visitBoolExpression(ctx.left), this.visitBoolExpression(ctx.right));
                break;
            case expGrammarParser_js_1.default.expGrammarParser.OR:
    ...
    visitVariableExpression(ctx) {
        ...
        return new astNode_1.IdentifierNode(id)
            .setTextPos(new astNode_1.TextPosition(ctx.start.line, ctx.start.column, ctx.start.start, ctx.stop.stop));
    }
    visitUnaryOperatorExpression(ctx) {
        switch (ctx.op.type) {
            case expGrammarParser_js_1.default.expGrammarParser.PLUS:
                return this.visitExpression(ctx.expression());
            case expGrammarParser_js_1.default.expGrammarParser.MINUS:
    ...
    visitBinaryOperatorExpression(ctx) {
        let op;
        switch (ctx.op.type) {
            case expGrammarParser_js_1.default.expGrammarParser.DIVISION:
                op = new astNode_1.DivisionNode(this.visitExpression(ctx.left), this.visitExpression(ctx.right));
                break;
            case expGrammarParser_js_1.default.expGrammarParser.ASTERISK:
            ...
            case expGrammarParser_js_1.default.expGrammarParser.MINUS:
                ...
                break;
            case expGrammarParser_js_1.default.expGrammarParser.CARET:
...
var Recognizer = __webpack_require__(28).Recognizer;
var DefaultErrorStrategy = __webpack_require__(34).DefaultErrorStrategy;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.compileExpression = exports.compileBoolExpression = exports.ExpCompilerContext = void 0;
const error_1 = __importDefault(__webpack_require__(37));
const astNode_1 = __webpack_require__(20);
const expression_1 = __webpack_require__(22);
...
function compileExpression(item, context) {
    switch (item.type) {
        ...
        case astNode_1.NodeType._Identifier: {
            let _var = item;
            if (context.indicies.hasOwnProperty(_var.id)) {
                return new expression_1.Variable(context.indicies[_var.id], _var.id);
            }
            context.errors.push(new error_1.default(item.textPos, `Unexpected variable "${_var.id}" at compileExpression()`));
            return new expression_1.Constant(0);
        }
        default:
...
Object.defineProperty(exports, "__esModule", { value: true });
const error_1 = __importDefault(__webpack_require__(33));
const error_2 = __importDefault(__webpack_require__(37));
const astNode_1 = __webpack_require__(20);
...
/***/ })
/******/ ]);
//# sourceMappingURL=evalExp.js.map